...
type EventsClient interface {
	...
	ListAll(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error)
...
func (c *eventsClient) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *eventsClient) DeleteAll(ctx context.Context, in *DeleteAllRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/event.Events/DeleteAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventsClient) ListAll(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	out := new(ListResponse)
	err := c.cc.Invoke(ctx, "/event.Events/ListAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EventsServer interface {
	...
	ListAll(context.Context, *ListRequest) (*ListResponse, error)
...
func (UnimplementedEventsServer) Update(context.Context, *UpdateRequest) (*emptypb.Empty, error) {
...
func (UnimplementedEventsServer) ListAll(context.Context, *ListRequest) (*ListResponse, error) {
...
func _Events_DeleteAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/event.Events/DeleteAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Events_ListAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EventsServer).ListAll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/event.Events/ListAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventsServer).ListAll(ctx, req.(*ListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Events_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListAll",
			Handler:    _Events_ListAll_Handler,
		},
		{
			MethodName: "ListDay",
	...
	Metadata: "events/EventService.proto",
}
